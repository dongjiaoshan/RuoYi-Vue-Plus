 ...
 * <ol>
 *   <li>开始日期 − 当前日期 &gt; 30 天 → {@link #PENDING}（上市：待上市／采摘：待采摘）</li>
 *   <li>开始日期 − 当前日期 ≤ 30 天 → {@link #UPCOMING}（即将上市／即将采摘）</li>
 *   <li>当前日期 &gt; 开始日期 且 结束日期 − 当前日期 &gt; 15 天 → {@link #ON_SALE}（上市中／采摘中）</li>
 *   <li>当前日期 &gt; 开始日期 且 结束日期 − 当前日期 ≤ 15 天 → {@link #ENDING}（即将下市／即将结束采摘）</li>
 *   <li>当前日期 &gt; 结束日期 → {@link #OFF_SHELF}（已下架／完成采摘）</li>
 * </ol>
 *
