...
CREATE TABLE t_warehouse_check_record (
  ...
  check_status    VARCHAR(16)  NOT NULL DEFAULT 'draft' COMMENT '状态 draft/in_progress/completed',
...
CREATE TABLE t_warehouse_demand_manage (
  ...
  demand_status       VARCHAR(16)  NOT NULL DEFAULT 'DRAFT' COMMENT '状态 enum：DRAFT/SUBMITTED/CONFIRMED/IN_PRODUCTION/PARTIAL_SHIPPED/COMPLETED/CANCELLED',
...
CREATE TABLE t_warehouse_trace_code (
  ...
  create_by           VARCHAR(64)  DEFAULT '' COMMENT '生成人',
